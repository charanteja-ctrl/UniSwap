            ...
            {user ? (
              <div className="relative" ref={dropdownRef}>
                <button
                  ...
                  className="flex items-center gap-2.5 bg-white/10 hover:bg-white/15 px-3 py-1.5 rounded-xl border border-white/10 text-xs transition"
                >
